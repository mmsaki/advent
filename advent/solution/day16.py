...
import advent.lib.aoc
import advent.lib.graph
...
def part1(s):
    ...
    advent.lib.aoc.give_answer(2022, 16, 1, answer)
...
def part2(s):
    ...
    graph = advent.lib.graph.make_lazy_graph(neighbor_fn)
    ...
    least_missed_flow = advent.lib.graph.dijkstra_length_fuzzy_end(graph, start, end_fn)

    answer = TOTAL_MAXIMUM_FLOW - least_missed_flow

    advent.lib.aoc.give_answer(2022, 16, 2, answer)

input = open("advent/resources/day16.txt").read()
